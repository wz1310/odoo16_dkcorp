...
class StockMove(models.Model):
    ...
    def _action_done(self, cancel_backorder=False):
        # PASTIKAN: Untuk produk service di MO raw material, 
        # jika quantity_done masih 0, isi dari product_uom_qty agar tidak di-reset Odoo.
        for move in self:
    ...
    def _create_out_svl(self, forced_quantity=None):
        ...
        for move in service_moves:
            # Gunakan quantity_done yang sudah diisi di _action_done
            quantity = forced_quantity or move.quantity_done or move.product_uom_qty
